...
const SidebarLayout = () => {
  ...
  return (
    <div className="flex h-screen">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed md:relative top-0 left-0 w-64 bg-gray-800 text-white p-4 text-center transform transition-transform duration-300 
      ...
      >
        <nav>
          <ul className="space-y-4">
            ...
            <li className="border-b border-gray-500 hover:border-gray-400 pb-3">
              <div className="pb-12 text-center">{user ? user.name : "Loading..."}</div>
            </li>
            <li className="border-b border-gray-500 hover:border-gray-400 pb-3">
              <Link to="appointment" className="hover:text-gray-100 hover:font-bold">
                New Appointment
            ...
            <li className="border-b border-gray-500 hover:border-gray-400 pb-3">
              <button
                onClick={handleLogout}
                className="bg-red-600 text-white py-1 px-6 rounded hover:bg-red-700"
              >
                Logout
              </button>
            </li>
