            ...
            <div className="min-h-screen flex flex-col-reverse md:flex-row items-center justify-center default">
                ...
                <div className="w-full md:w-1/2 grid grid-cols-2 gap-2">
                    <div className="aspect-square overflow-hidden shadow-lg">
                        <img src={slide_image_11} alt="Slide 11" className="w-full h-full object-cover" />
                    </div>
                    <div className="aspect-square overflow-hidden shadow-lg">
                        <img src={slide_image_13} alt="Slide 13" className="w-full h-full object-cover" />
                    </div>
                    <div className="aspect-square overflow-hidden shadow-lg">
                        <img src={slide_image_12} alt="Slide 12" className="w-full h-full object-cover" />
                    </div>
                    <div className="aspect-square overflow-hidden shadow-lg">
                        <img src={slide_image_8} alt="Slide 8" className="w-full h-full object-cover" />
                    </div>
                </div>
            </div>
        </div>
